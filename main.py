...
class SpacedRepetitionSystem:
    ...
    def get_topics_to_review(self, subject: str = None) -> List[str]:
        ...
        if subject:
            due_topics = {topic for topic in self.subjects.get(subject, set())
    ...
    def show_progress(self):
        ...
        for topic, topic_data in sorted_topics:
            print(f"- {topic} ({topic_data['subject']}): {topic_data['reviews']} reviews")
    ...
    def study_session(self):
        ...
        subject = input("Enter a subject to focus on (or press Enter for all subject): ").strip()
        if subject not in self.subjects:
            print(f"Subject '{subject}' not found.")
            return
        
        play_music = input("Do you want to play music for this study session? (y/n): ").lower().strip()
        if play_music == "y":
            self.toggle_music()
        ...
        while time.time() < end_time:
            ...
            print(f"Review topic: {topic} (subject: {self.data['topics'][topic]['subject']})")
    ...
    def import_data(self):
        ...
        try:
            ...
            if not all(key in imported_data for key in ["topics", "total_reviews", "subjects"]):
    ...
    def export_to_csv(self):
        ...
        try:
            with open(filename, 'w', newline='') as csvfile:
                ...
                writer.writerow(["Topic", "subject", "Level", "Next Review", "Difficulty", "Reviews"])
